...
class App(QWidget):
    ...
    def initUI(self):
        ...
        self.probe_map = {'Probe A1': 0, 'Probe B1': 1, 'Probe C1': 2, 'Probe D1' : 3,
                          ...
                          'Probe A3': 12, 'Probe B3': 13, 'Probe C3': 14, 'Probe D3' : 15,
                          'Probe E3': 16, 'Probe F3': 17,
                          'Probe A4': 18, 'Probe B4': 19, 'Probe C4': 20, 'Probe D4' : 21,
                          'Probe E4': 22, 'Probe F4': 23,
                     }
        ...
        self.color_map = {'Probe A1': 'darkred', 'Probe B1': 'cadetblue',
                     ...
                     'Probe A3': 'salmon', 'Probe B3': 'deepskyblue',
                     'Probe C3': 'beige', 'Probe D3' : 'lime',
                     'Probe E3': 'cornflowerblue', 'Probe F3': 'mediumslateblue',
                     
                     'Probe A4': 'orangered', 'Probe B4': 'cyan',
                     'Probe C4': 'wheat', 'Probe D4' : 'lawngreen',
                     'Probe E4': 'lightsteelblue', 'Probe F4': 'magenta'}
        ...
        subgrid.addWidget(self.coronal_button,5,0)
        subgrid.addWidget(self.horizontal_button,5,1)
        subgrid.addWidget(self.sagittal_button,5,2)
        subgrid.addWidget(self.projection_button,5,3)
        subgrid.addWidget(self.pointLock_button,5,4,1,2)
        
        subgrid.addWidget(self.switch_probe_button,6,0,1,1)
        subgrid.addWidget(self.levelsLowField,6,1,1,1)
        subgrid.addWidget(self.levelsHighField,6,2,1,1)
        subgrid.addWidget(self.updateButton,6,3,1,1)
        ...
        subgrid.addWidget(save_button,6,4)
        subgrid.addWidget(load_button,6,5)
                ...
                if shouldDraw:
                    ...
                    for j in range(x-10,x+10):
                        for k in range(y-10,y+10):
                            if row.probe_name[-1] == '1' or row.probe_name[-1] == '2':
